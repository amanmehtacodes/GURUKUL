...
Lockers toggled *exactly twice* have exactly two factors — these are the **prime numbers**: $2, 3, 5, 7, 11, \ldots$, giving the passcode $2\text{-}3\text{-}5\text{-}7\text{-}11$.
...
This "inverted-L" (gnomon) picture shows *why* each new odd number extends a square into the next square:
...
Triangular numbers ($1, 3, 6, 10, 15,\ldots$) count dots arranged in a triangle. Adding two *consecutive* triangular numbers gives a perfect square:
