...
function Y(e, t, s) {
  let i = t[0],
    ...
    l = s[2];
  return (
    (e[0] = r * l - n * a), (e[1] = n * h - i * l), (e[2] = i * a - r * h), e
  );
}
function ut(e, t, s, i) {
  let r = t[0],
...
function Mt(e, t, s) {
  ...
  return (
    (h = h || 1),
    (e[0] = (s[0] * i + s[4] * r + s[8] * n + s[12]) / h),
    (e[1] = (s[1] * i + s[5] * r + s[9] * n + s[13]) / h),
    (e[2] = (s[2] * i + s[6] * r + s[10] * n + s[14]) / h),
    e
  );
}
function yt(e, t, s) {
  ...
  return (
    (h = h || 1),
    (e[0] = (s[0] * i + s[4] * r + s[8] * n) / h),
    (e[1] = (s[1] * i + s[5] * r + s[9] * n) / h),
    (e[2] = (s[2] * i + s[6] * r + s[10] * n) / h),
    e
  );
}
function Ft(e, t, s) {
...
var R = class e extends Array {
  constructor(t = 0, s = t, i = t) {
    return super(t, s, i), this;
  }
  get x() {
    return this[0];
  }
  ...
  set(t, s = t, i = t) {
    return t.length ? this.copy(t) : (ct(this, t, s, i), this);
  }
  copy(t) {
    return I(this, t), this;
  }
  add(t, s) {
    return s ? X(this, t, s) : X(this, this, t), this;
  }
  sub(t, s) {
    return s ? k(this, t, s) : k(this, this, t), this;
  }
  multiply(t) {
    return t.length ? ft(this, this, t) : D(this, this, t), this;
  }
  divide(t) {
    return t.length ? dt(this, this, t) : D(this, this, 1 / t), this;
  }
  inverse(t = this) {
    return ot(this, t), this;
  }
  len() {
    return T(this);
  }
  distance(t) {
    return t ? pt(this, t) : T(this);
  }
  squaredLen() {
    return G(this);
  }
  squaredDistance(t) {
    return t ? gt(this, t) : G(this);
  }
  negate(t = this) {
    return xt(this, t), this;
  }
  cross(t, s) {
    return s ? Y(this, t, s) : Y(this, this, t), this;
  }
  scale(t) {
    return D(this, this, t), this;
  }
  normalize() {
  ...
  lerp(t, s) {
    return ut(this, this, t, s), this;
  }
  smoothLerp(t, s, i) {
    return mt(this, this, t, s, i), this;
  }
  clone() {
    return new e(this[0], this[1], this[2]);
  }
  fromArray(t, s = 0) {
    return (this[0] = t[s]), (this[1] = t[s + 1]), (this[2] = t[s + 2]), this;
  }
  toArray(t = [], s = 0) {
    return (t[s] = this[0]), (t[s + 1] = this[1]), (t[s + 2] = this[2]), t;
  }
  transformDirection(t) {
    let s = this[0],
      ...
      r = this[2];
    return (
      (this[0] = t[0] * s + t[4] * i + t[8] * r),
      (this[1] = t[1] * s + t[5] * i + t[9] * r),
      (this[2] = t[2] * s + t[6] * i + t[10] * r),
      this.normalize()
    );
  }
};
  ...
  j = class {
    constructor({
      ...
      (this.dpr = r),
        ...
        (this.autoClear = p),
        (this.id = Ee++),
        g === 2 && (this.gl = t.getContext("webgl2", x)),
    ...
    setViewport(t, s, i = 0, r = 0) {
      (this.state.viewport.width === t && this.state.viewport.height === s) ||
        ((this.state.viewport.width = t),
        (this.state.viewport.height = s),
        (this.state.viewport.x = i),
        (this.state.viewport.y = r),
        this.gl.viewport(i, r, t, s));
    }
    setScissor(t, s, i = 0, r = 0) {
      this.gl.scissor(i, r, t, s);
    }
    enable(t) {
    ...
    setBlendFunc(t, s, i, r) {
      (this.state.blendFunc.src === t &&
        ...
        (this.state.blendFunc.dstAlpha = r),
        i !== void 0
          ? this.gl.blendFuncSeparate(t, s, i, r)
    ...
    setStencilMask(t) {
      this.state.stencilMask !== t &&
        ((this.state.stencilMask = t), this.gl.stencilMask(t));
    }
    setStencilFunc(t, s, i) {
      (this.state.stencilFunc === t &&
    ...
    getRenderList({ scene: t, camera: s, frustumCull: i, sort: r }) {
      let n = [];
      if (
        (s && i && s.updateFrustum(),
        t.traverse((h) => {
        ...
        n.forEach((c) => {
          c.program.transparent
            ...
            !(c.renderOrder !== 0 || !c.program.depthTest || !s) &&
              (c.worldMatrix.getTranslation(Z),
              Z.applyMatrix4(s.projectionViewMatrix),
              (c.zDepth = Z.z));
        }),
  ...
  K = class {
    constructor(
      ...
      t.canvas || console.error("gl not passed as first argument to Program"),
        ...
        this.setShaders({ vertex: s, fragment: i });
    }
...
${bt(s)}`)),
      ...
      for (let h = 0; h < i; h++) {
        ...
        this.uniformLocations.set(
          a,
          this.gl.getUniformLocation(this.program, a.name)
        );
      ...
      let r = [],
        n = this.gl.getProgramParameter(
          this.program,
          this.gl.ACTIVE_ATTRIBUTES
        );
      for (let h = 0; h < n; h++) {
        let a = this.gl.getActiveAttrib(this.program, h),
    ...
    setBlendEquation(t, s) {
      (this.blendEquation.modeRGB = t), (this.blendEquation.modeAlpha = s);
    }
    setStencilFunc(t, s, i) {
      (this.stencilRef = s),
        ...
        this.uniformLocations.forEach((r, n) => {
          ...
          for (let a of n.nameComponents) {
            ...
            if (a in h) h = h[a];
              ...
              if (Array.isArray(h.value)) break;
              h = void 0;
              break;
            }
          }
          if (!h) return St(`Active uniform ${n.name} has not been supplied`);
          if (h && h.value === void 0)
            return St(`${n.name} uniform is missing a value parameter`);
          if (h.value.texture)
            return (s = s + 1), h.value.update(s), $(this.gl, n.type, r, s);
...
function $(e, t, s, i) {
  i = i.length ? Ae(i) : i;
  let r = e.renderer.state.uniformLocations.get(s);
  if (i.length)
    if (r === void 0 || r.length !== i.length)
      e.renderer.state.uniformLocations.set(s, i.slice(0));
    else {
      if (ze(r, i)) return;
      r.set ? r.set(i) : be(r, i), e.renderer.state.uniformLocations.set(s, r);
    }
  else {
    if (r === i) return;
...
function Nt(e, t) {
  let s = t[0],
    ...
    h = s * s + i * i + r * r + n * n,
    a = h ? 1 / h : 0;
  return (e[0] = -s * a), (e[1] = -i * a), (e[2] = -r * a), (e[3] = n * a), e;
}
function Pt(e, t) {
  return (e[0] = -t[0]), (e[1] = -t[1]), (e[2] = -t[2]), (e[3] = t[3]), e;
}
function qt(e, t) {
  ...
  if (s > 0)
    ...
    let n = (r + 1) % 3,
      h = (r + 2) % 3;
    (i = Math.sqrt(t[r * 3 + r] - t[n * 3 + n] - t[h * 3 + h] + 1)),
      (e[r] = 0.5 * i),
      (i = 0.5 / i),
      (e[3] = (t[n * 3 + h] - t[h * 3 + n]) * i),
      (e[n] = (t[n * 3 + r] + t[r * 3 + n]) * i),
      (e[h] = (t[h * 3 + r] + t[r * 3 + h]) * i);
  }
  return e;
}
function Ut(e, t, s = "YXZ") {
...
var N = class extends Array {
  constructor(t = 0, s = 0, i = 0, r = 1) {
    super(t, s, i, r), (this.onChange = () => {}), (this._target = this);
    let n = ["0", "1", "2", "3"];
  ...
  set(t, s, i, r) {
    return t.length
      ? this.copy(t)
      : (Xt(this._target, t, s, i, r), this.onChange(), this);
  }
  rotateX(t) {
    return vt(this._target, this._target, t), this.onChange(), this;
  }
  rotateY(t) {
    return It(this._target, this._target, t), this.onChange(), this;
  }
  rotateZ(t) {
    return Bt(this._target, this._target, t), this.onChange(), this;
  }
  inverse(t = this._target) {
    return Nt(this._target, t), this.onChange(), this;
  }
  conjugate(t = this._target) {
    return Pt(this._target, t), this.onChange(), this;
  }
  copy(t) {
    return Qt(this._target, t), this.onChange(), this;
  }
  normalize(t = this._target) {
    return Gt(this._target, t), this.onChange(), this;
  }
  multiply(t, s) {
    return (
      s ? J(this._target, t, s) : J(this._target, this._target, t),
      this.onChange(),
      this
    );
  }
  dot(t) {
    return kt(this._target, t);
  }
  fromMatrix3(t) {
    return qt(this._target, t), this.onChange(), this;
  }
  fromEuler(t, s) {
    return Ut(this._target, t, t.order), s || this.onChange(), this;
  }
  fromAxisAngle(t, s) {
    return Tt(this._target, t, s), this.onChange(), this;
  }
  slerp(t, s) {
    return Dt(this._target, this._target, t, s), this.onChange(), this;
  }
  fromArray(t, s = 0) {
    return (
      (this._target[0] = t[s]),
...
function Yt(e, t, s, i, r, n, h, a, l, c, f, d, p, g, x, o, u) {
  return (
    (e[0] = t),
    (e[1] = s),
    (e[2] = i),
...
function tt(e) {
  let t = e[0],
    ...
    O = f * u - p * x,
    b = d * u - p * o;
  return m * b - w * O + y * z + M * C - _ * S + F * A;
}
function et(e, t, s) {
  let i = t[0],
    r = t[1],
  ...
  return (
    ...
    (e[8] = y * i + M * a + _ * d + F * o),
    (e[9] = y * r + M * l + _ * p + F * u),
    (e[10] = y * n + M * c + _ * g + F * m),
    (e[11] = y * h + M * f + _ * x + F * w),
    (y = s[12]),
    (M = s[13]),
    (_ = s[14]),
    (F = s[15]),
    (e[12] = y * i + M * a + _ * d + F * o),
    (e[13] = y * r + M * l + _ * p + F * u),
    (e[14] = y * n + M * c + _ * g + F * m),
    (e[15] = y * h + M * f + _ * x + F * w),
    e
  );
}
function $t(e, t, s) {
  ...
  return (
    t === e
      ? ((e[12] = t[0] * i + t[4] * r + t[8] * n + t[12]),
        (e[13] = t[1] * i + t[5] * r + t[9] * n + t[13]),
        (e[14] = t[2] * i + t[6] * r + t[10] * n + t[14]),
        (e[15] = t[3] * i + t[7] * r + t[11] * n + t[15]))
      : ((h = t[0]),
        (a = t[1]),
        (l = t[2]),
        (c = t[3]),
        ...
        (e[10] = u),
        (e[11] = m),
        (e[12] = h * i + f * r + x * n + t[12]),
        (e[13] = a * i + d * r + o * n + t[13]),
        (e[14] = l * i + p * r + u * n + t[14]),
        (e[15] = c * i + g * r + m * n + t[15])),
    e
  );
}
function Ht(e, t, s) {
...
function te(e) {
  let t = e[0],
    ...
    d = r * r + n * n + h * h,
    p = a * a + l * l + c * c;
  return Math.sqrt(Math.max(f, d, p));
}
var it = (function () {
  let e = [1, 1, 1];
  return function (t, s) {
    ...
    return (
      u > 0
        ? ((m = Math.sqrt(u + 1) * 2),
          ...
          (t[2] = (l - f) / m))
        : a > d && a > o
        ? ((m = Math.sqrt(1 + a - d - o) * 2),
          (t[3] = (p - x) / m),
          (t[0] = 0.25 * m),
          (t[1] = (l + f) / m),
          (t[2] = (g + c) / m))
        : d > o
        ? ((m = Math.sqrt(1 + d - a - o) * 2),
          (t[3] = (g - c) / m),
          (t[0] = (l + f) / m),
          (t[1] = 0.25 * m),
          (t[2] = (p + x) / m))
        : ((m = Math.sqrt(1 + o - a - d) * 2),
          (t[3] = (l - f) / m),
          (t[0] = (g + c) / m),
          (t[1] = (p + x) / m),
          (t[2] = 0.25 * m)),
...
function ee(e, t, s, i) {
  let r = T([e[0], e[1], e[2]]),
    n = T([e[4], e[5], e[6]]),
    h = T([e[8], e[9], e[10]]);
  tt(e) < 0 && (r = -r), (s[0] = e[12]), (s[1] = e[13]), (s[2] = e[14]);
  let l = e.slice(),
    c = 1 / r,
    f = 1 / n,
    d = 1 / h;
...
function he(e, t, s, i) {
  let r = t[0],
    ...
    p = h - s[2],
    g = f * f + d * d + p * p;
  g === 0 ? (p = 1) : ((g = 1 / Math.sqrt(g)), (f *= g), (d *= g), (p *= g));
  let x = l * p - c * d,
    o = c * f - a * p,
    u = a * d - l * f;
  return (
...
var V = class extends Array {
  constructor(
    ...
    return super(t, s, i, r, n, h, a, l, c, f, d, p, g, x, o, u), this;
  }
  get x() {
    return this[12];
  }
  ...
  set(t, s, i, r, n, h, a, l, c, f, d, p, g, x, o, u) {
    return t.length
      ? this.copy(t)
      : (Yt(this, t, s, i, r, n, h, a, l, c, f, d, p, g, x, o, u), this);
  }
  translate(t, s = this) {
    return $t(this, s, t), this;
  }
  rotate(t, s, i = this) {
    return Kt(this, i, t, s), this;
  }
  scale(t, s = this) {
    return Ht(this, s, typeof t == "number" ? [t, t, t] : t), this;
  }
  add(t, s) {
    return s ? rt(this, t, s) : rt(this, this, t), this;
  }
  sub(t, s) {
    return s ? nt(this, t, s) : nt(this, this, t), this;
  }
  multiply(t, s) {
    return (
      t.length ? (s ? et(this, t, s) : et(this, this, t)) : le(this, this, t),
      this
    );
  }
  identity() {
  ...
  fromPerspective({ fov: t, aspect: s, near: i, far: r } = {}) {
    return re(this, t, s, i, r), this;
  }
  fromOrthogonal({ left: t, right: s, bottom: i, top: r, near: n, far: h }) {
    return ne(this, t, s, i, r, n, h), this;
  }
  fromQuaternion(t) {
    return ie(this, t), this;
  }
  setPosition(t) {
  ...
  compose(t, s, i) {
    return se(this, t, s, i), this;
  }
  decompose(t, s, i) {
    return ee(this, t, s, i), this;
  }
  getRotation(t) {
    return it(t, this), this;
  }
  getTranslation(t) {
    return Jt(t, this), this;
  }
  getScaling(t) {
    return st(t, this), this;
  }
  getMaxScaleOnAxis() {
    return te(this);
  }
  lookAt(t, s, i) {
    return he(this, t, s, i), this;
  }
  determinant() {
    return tt(this);
  }
    ...
    s === "XYZ"
      ...
      ? ((e[0] = Math.asin(-Math.min(Math.max(t[9], -1), 1))),
        Math.abs(t[9]) < 0.99999
          ? ((e[1] = Math.atan2(t[8], t[10])), (e[2] = Math.atan2(t[1], t[5])))
...
var ce = new V(),
  P = class extends Array {
    ...
    fromRotationMatrix(t, s = this.order) {
      return ae(this._target, t, s), this.onChange(), this;
    }
    fromQuaternion(t, s = this.order, i) {
      return (
        ce.fromQuaternion(t),
        this._target.fromRotationMatrix(ce, s),
        i || this.onChange(),
        this
      );
    }
...
function ge(e, t, s, i, r, n, h, a, l, c) {
  return (
    (e[0] = t),
    (e[1] = s),
    (e[2] = i),
...
var U = class extends Array {
  constructor(t = 1, s = 0, i = 0, r = 0, n = 1, h = 0, a = 0, l = 0, c = 1) {
    return super(t, s, i, r, n, h, a, l, c), this;
  }
  set(t, s, i, r, n, h, a, l, c) {
    return t.length
      ? this.copy(t)
      : (ge(this, t, s, i, r, n, h, a, l, c), this);
  }
  translate(t, s = this) {
    return ue(this, s, t), this;
  }
  rotate(t, s = this) {
    return me(this, s, t), this;
  }
  scale(t, s = this) {
    return Me(this, s, t), this;
  }
  multiply(t, s) {
    return s ? ht(this, t, s) : ht(this, this, t), this;
  }
  identity() {
    return xe(this), this;
  }
  copy(t) {
    return pe(this, t), this;
  }
  fromMatrix4(t) {
  ...
  fromBasis(t, s, i) {
    return this.set(t[0], t[1], t[2], s[0], s[1], s[2], i[0], i[1], i[2]), this;
  }
  inverse(t = this) {
  ...
  lt = class extends q {
    constructor(
      ...
      super(),
        ...
        (this.renderOrder = h),
        (this.modelViewMatrix = new V()),
        (this.normalMatrix = new U()),
...
var Fe = new R(),
  ...
  Q = class {
    ...
    bindAttributes(t) {
      t.attributeLocations.forEach((s, { name: i, type: r }) => {
    ...
    draw({ program: t, mode: s = this.gl.TRIANGLES }) {
      this.gl.renderer.currentGeometry !== `${this.id}_${t.attributeOrder}` &&
        ...
        this.gl.renderer.bindVertexArray(this.VAOs[t.attributeOrder]),
        (this.gl.renderer.currentGeometry = `${this.id}_${t.attributeOrder}`)),
        t.attributeLocations.forEach((r, { name: n }) => {
          let h = this.attributes[n];
    ...
    computeBoundingSphere(t) {
      ...
      for (let n = 0, h = s.length; n < h; n += i)
        Fe.fromArray(s, n),
          (r = Math.max(r, this.bounds.center.squaredDistance(Fe)));
...
export { lt as Mesh, K as Program, j as Renderer, at as Triangle };
