...
A **quadrilateral** is a closed four-sided figure. The word comes from Latin: _quadri_ (four) + _latus_ (side).
...
A. **"Four sides"** — _quadri_ means four, _latus_ means side.
